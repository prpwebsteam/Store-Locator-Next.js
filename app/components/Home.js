              ...
              <div className="relative max-w-screen-lg px-4 mx-auto lg:px-0" data-hero-video="">
                  ...
                  <div className="absolute inset-0" data-play="">
                      <div className="flex h-full">
                          <div className="flex items-center px-6 py-4 m-auto text-white transition-all rounded-full shadow-lg cursor-pointer bg-purple shadow-purple/20 hover:shadow-xl hover:-translate-y-1 motion-safe:animate-fade-in">
