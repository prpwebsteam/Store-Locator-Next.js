...
const Settings = () => {
  ...
  return (
    <>
      ...
      <div className='bg-white px-8 py-8 mx-6 rounded-md'>
        <form className='grid grid-cols-2 gap-6' encType="multipart/form-data">
          ...
          <div className='flex flex-col  justify-center mb-4 items-left'>
